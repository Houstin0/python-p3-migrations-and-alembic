...
Revision ID: eddc8e8c3371
Revises: 455c74141b76
Create Date: 2023-09-02 21:10:38.941234
...
revision = 'eddc8e8c3371'
down_revision = '455c74141b76'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.UniqueConstraint('email', name='uique_email')
    )
